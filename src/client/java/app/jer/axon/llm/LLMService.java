...
public class LLMService {
    ...
    public static void initialize() {
        agentExecutor.submit(LLMService::agentLoop);
    ...
    private static void triggerLLM() {
        ...
        // int maxHistory = 30; // Keep last N messages + system prompt
